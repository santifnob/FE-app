    ...
    const onSubmit = async (formData) => {
        ...
        try {
            if (categoriaDenunciaToEdit) {
                ...
                showFeedback('success', 'Categoría actualizada', 'La categoría de denuncia se actualizó correctamente.')
            } else {
                await handlePost(categoriaDenuncia)
                showFeedback('success', 'Categoría creada', 'La categoría de denuncia se creó correctamente.')
            }
            onSuccess()
        } catch (error) {
            showFeedback('danger', 'Error', `No se pudo ${categoriaDenunciaToEdit ? 'actualizar' : 'crear'} la categoría de denuncia. Intenta nuevamente.`)
        }
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='mb-1'>
                ...
                <input
                    id='titulo' type='text' {...register('titulo', {
            ...
            <div className='mb-1'>
                ...
                <input
                    id='descripcion' type='text' {...register('descripcion', {
