    ...
    const onSubmit = async (formData) => {
        ...
        try {
            if (recorridoToEdit) {
                ...
                showFeedback('success', 'Recorrido actualizado', 'El recorrido se actualizó correctamente.')
            } else {
                await handlePost(recorrido)
                showFeedback('success', 'Recorrido creado', 'El recorrido se creó correctamente.')
            }
            onSuccess()
        } catch (error) {
            showFeedback('danger', 'Error', `No se pudo ${recorridoToEdit ? 'actualizar' : 'crear'} el recorrido. Intenta nuevamente.`)
        }
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='mb-1'>
                ...
                <input
                    id='ciudadSalida' type='text' {...register('ciudadSalida', {
                        required: 'La "Ciudad de salida" es requerida'
            ...
            <div className='mb-1'>
                ...
                <input
                    id='ciudadLlegada' type='text' {...register('ciudadLlegada', {
                        required: 'La "Ciudad de llegada" es requerida'
