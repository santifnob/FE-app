    ...
    const onSubmit = async (formData) => {
        ...
        try {
            if (tipoCargaToEdit) {
                ...
                showFeedback('success', 'Tipo de carga actualizado', 'El tipo de carga se actualizó correctamente.')
            } else {
                await handlePost(tipoCarga)
                showFeedback('success', 'Tipo de carga creado', 'El tipo de carga se creó correctamente.')
            }
            onSuccess()
        } catch (error) {
            showFeedback('danger', 'Error', `No se pudo ${tipoCargaToEdit ? 'actualizar' : 'crear'} el tipo de carga. Intenta nuevamente.`)
        }
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='mb-1'>
                ...
                <input
                    id='desc' type='text' {...register('desc', {
